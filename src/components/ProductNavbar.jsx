...
import { Menu, X, HelpCircle, Settings, ShoppingCart } from 'lucide-react';
...
const ProductNavbar = () => {
  ...
  return (
    <header className="w-full fixed top-0 right-0 left-0 z-40 px-4 md:px-8 pt-4 md:pt-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2 text-gray-400">
            ...
            <button 
              ...
              className="relative p-1 sm:p-1.5 hover:text-[#D9FF00] transition-colors rounded-full hover:bg-white/5"
            >
              <ShoppingCart size={16} />
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-[#D9FF00] text-black text-[9px] font-extrabold w-4 h-4 rounded-full flex items-center justify-center leading-none">
