...
export default function MoreThanHardware() {
  ...
  return (
    <section className="w-full bg-[#F3F3E7] text-[#0C0C0E] font-['Poppins',sans-serif] py-4 lg:py-8 px-6 sm:px-10 lg:px-14">
      <div className="w-full">

        {/* TOP SECTION: Text Info + Display Screens Image */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-center mb-12 lg:mb-16 lg:pl-8 xl:pl-12">
            ...
            <div className="mb-6 space-y-1">
              <div>
                <HeadersH1
                  ...
                  parts={[{ text: 'More Than Just', color: '#0C0C0E', size: 'clamp(2.5rem, 5vw, 7rem)' }]}
                />
              </div>
              <div>
                <HeadersH1
                  leading="0.8em"
                  letterSpacing="-0.06em"
                  parts={[{ text: 'Hardware', color: '#0C0C0E', size: 'clamp(2.5rem, 5vw, 7rem)' }]}
                />
              </div>
            </div>

            <p className="text-[#000000] font-normal font-['Poppins',sans-serif] mb-8" style={{ fontSize: "clamp(1.25rem, 1vw, 1.875rem)", lineHeight: "132%", letterSpacing: "0%" }}>
              Ilaan provides more than screens.
            </p>

            <h3 className="text-black font-semibold font-['Poppins',sans-serif] mb-6" style={{ fontSize: "27px", lineHeight: "132%", letterSpacing: "0%" }}>
            ...
            <div className="space-y-4 mb-8">
              {steps.map((step, index) => (
                <div key={index} className="flex items-center gap-4">
                  <div className="w-[23px] h-[23px] rounded-full bg-[#FFFF00] text-black font-bold text-sm flex items-center justify-center shrink-0 shadow-sm">
                    {index + 1}
                  </div>
                  <span className="text-black font-normal font-['Poppins',sans-serif]" style={{ fontSize: "15px", lineHeight: "132%", letterSpacing: "0%" }}>
                    {step}
                  </span>
                </div>
              ))}
          ...
          <div className="lg:col-span-7 flex justify-center lg:justify-end items-center">
            <div className="w-full max-w-[1146px] aspect-[1146/600] flex items-center justify-center -mt-4 lg:-mt-8">
              <img
                src={screensImg}
                alt="Ilaan Digital Display Screens"
                className="w-full h-full object-contain drop-shadow-lg"
                style={{ maxHeight: 'clamp(300px, 40vh, 560px)' }}
              />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Card 1: ILAAN Media */}
          <div
            className="bg-[#000000] text-white rounded-[28px] p-8 lg:p-10 flex flex-col justify-between relative overflow-hidden shadow-2xl w-full max-w-[600px] mx-auto min-h-[600px] border border-black"
            style={{ backgroundImage: `url(${mediaBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
          >
            <div>
              <div className="w-[170px] h-[119px] mb-8">
                <img src={iconS1} alt="Media Icon" className="w-full h-full object-contain" />
              </div>

              <h4 className="text-[40px] lg:text-[44px] font-bold mb-4">ILAAN Media</h4>
              <p className="text-white text-[22px] leading-[132%] tracking-[0%] font-normal mb-10">
                Plan and run campaigns across connected screens.
              </p>

              <ul className="space-y-5 text-[19px] leading-[132%] tracking-[0%] text-white font-normal">
          ...
          >
            <div>
              ...
              <h4 className="text-[40px] lg:text-[44px] font-bold mb-4">Digital Signage</h4>
              <p className="text-white text-[22px] leading-[132%] tracking-[0%] font-normal mb-10">
          ...
          >
            <div>
              ...
              <h4 className="text-[40px] lg:text-[44px] font-bold mb-4">ILAAN Studio</h4>
              <p className="text-white text-[22px] leading-[132%] tracking-[0%] font-normal mb-10">
