...
const LinkFooter = () => {
    return (
        <section className="w-full overflow-x-hidden bg-[#FFFF00] py-4 px-2 sm:py-6 sm:px-3 lg:py-8 lg:px-4 xl:py-10 xl:px-5 3xl:py-12 3xl:px-6 4xl:py-14 4xl:px-8 flex justify-center items-center font-['Inter',sans-serif]">
            <div className="w-full max-w-full sm:max-w-full lg:max-w-[100%] mx-auto relative flex justify-center items-center">
                ...
                <div className="relative z-10 w-full h-full px-5 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12 xl:px-12 xl:py-14 3xl:px-16 3xl:py-16 4xl:px-20 4xl:py-20 flex flex-col justify-between items-center text-center">
                    ...
                    <div className="hidden lg:grid grid-cols-12 gap-4 xl:gap-8 3xl:gap-12 items-center w-full mb-6 xl:mb-8 3xl:mb-12">
                        ...
                        <div className="col-span-4 flex flex-col items-start text-left space-y-4 xl:space-y-6 3xl:space-y-8">
                            ...
                            >
                                ...
                                <span className="text-[#FFFF00]">Your Shelves</span>
                            </h2>
                            ...
                            <button
                                className="inline-flex items-center gap-2.5 xl:gap-4 bg-[#FFFF00] hover:bg-[#e6e600] text-black font-semibold px-5 py-2.5 sm:px-6 sm:py-3 xl:px-8 xl:py-4 rounded-full transition-all duration-300 shadow-[0_0_25px_rgba(255,255,0,0.4)] hover:scale-105 active:scale-95 cursor-pointer"
                    ...
                    */}
                    <div className="w-full border border-[#FFFF00]/60 rounded-[20px] sm:rounded-[24px] md:rounded-[28px] p-4 sm:p-5 md:p-6 lg:p-6 xl:p-7 3xl:p-9 4xl:p-12 bg-black/90 backdrop-blur-md relative overflow-hidden mt-2 lg:mt-4 3xl:mt-6 4xl:mt-8 mb-2 lg:mb-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 items-center divide-y md:divide-y-0 md:divide-x divide-[#FFFF00]/30">
                            ...
                            <div className="flex items-center gap-3 md:gap-4 3xl:gap-6 text-left py-4 md:py-0 md:px-4 3xl:px-6 first:pt-0 last:pb-0">
                                <div className="w-[44px] h-[44px] sm:w-[48px] sm:h-[48px] md:w-[52px] md:h-[52px] lg:w-[56px] lg:h-[56px] 3xl:w-[68px] 3xl:h-[68px] border border-[#FFFF00] bg-black rounded-[12px] lg:rounded-[14px] rotate-45 flex items-center justify-center shrink-0 shadow-[0_0_12px_rgba(255,255,0,0.3)]">
